        ...
        entryDiv.innerHTML = `
            <div class="commander-input-group">
                ...
                <select class="commander-theme-primary" required>
                    ...
                    <option value="Angels" data-tag="Kindred">Angels</option>
                    <option value="Assassins" data-tag="Kindred">Assassins</option>
                    <option value="Birds" data-tag="Kindred">Birds</option>
                    <option value="Cats" data-tag="Kindred">Cats</option>
                    <option value="Demons" data-tag="Kindred">Demons</option>
                    <option value="Dinosaurs" data-tag="Kindred">Dinosaurs</option>
                    <option value="Dragons" data-tag="Kindred">Dragons</option>
                    <option value="Eldrazi" data-tag="Kindred">Eldrazi</option>
                    <option value="Elementals" data-tag="Kindred">Elementals</option>
                    <option value="Elves" data-tag="Kindred">Elves</option>
                    <option value="Faeries" data-tag="Kindred">Faeries</option>
                    <option value="Frogs" data-tag="Kindred">Frogs</option>
                    <option value="Goblins" data-tag="Kindred">Goblins</option>
                    <option value="Horrors" data-tag="Kindred">Horrors</option>
                    <option value="Humans" data-tag="Kindred">Humans</option>
                    <option value="Hydras" data-tag="Kindred">Hydras</option>
                    <option value="Insects" data-tag="Kindred">Insects</option>
                    <option value="Knights" data-tag="Kindred">Knights</option>
                    <option value="Merfolk" data-tag="Kindred">Merfolk</option>
                    <option value="Myr" data-tag="Kindred">Myr</option>
                    <option value="Ninjas" data-tag="Kindred">Ninjas</option>
                    <option value="Phyrexians" data-tag="Kindred">Phyrexians</option>
                    <option value="Pirates" data-tag="Kindred">Pirates</option>
                    <option value="Rats" data-tag="Kindred">Rats</option>
                    <option value="Rogues" data-tag="Kindred">Rogues</option>
                    <option value="Saprolings" data-tag="Kindred">Saprolings</option>
                    <option value="Shapeshifters" data-tag="Kindred">Shapeshifters</option>
                    <option value="Slivers" data-tag="Kindred">Slivers</option>
                    <option value="Soldiers" data-tag="Kindred">Soldiers</option>
                    <option value="Spiders" data-tag="Kindred">Spiders</option>
                    <option value="Spirits" data-tag="Kindred">Spirits</option>
                    <option value="Vampires" data-tag="Kindred">Vampires</option>
